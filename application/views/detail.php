    ...
    <div class="container">
        <header class="border-bottom lh-1 py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-12">
                    <a class="blog-header-logo text-body-emphasis text-decoration-none" href="#">Simple Blog
                        Application</a>
                </div>
    ...
    <main class="container">
        <div class="row g-5">
            ...
            <div class="col-md-6 comment-box">
                <h3 class="pb-2">Please comment here!</h3>
                <form action="<?php echo base_url().'home/blogDetail/'.$blog['blog_id']; ?>" method="post" name="commentForm">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="comment" id="comment" value="" class="form-control" row="5"><?php echo set_value('comment'); ?></textarea>
            ...
            <div class="col-md-12 pb-5">
                <h3 class="pb-2 mt-2">Comments</h3>
                <hr>
